...
public static class ItemNames
{
    ...
    public const string Shard_Bundle = "Shard_Bundle"; // 80 shards
    public const string Beast_Shard = "Beast_Shard"; // 140 shards
    public const string Pristine_Core = "Pristine_Core"; // 220 shards
    ...
    public const string Spa_Pins = "Spa_Pins";
    public const string Flea_Pins_Marrowlands = "Flea_Pins_Marrowlands";
    public const string Flea_Pins_Midlands = "Flea_Pins_Midlands";
    public const string Flea_Pins_Blastedlands = "Flea_Pins_Blastedlands";
    public const string Flea_Pins_Citadel = "Flea_Pins_Citadel";
    public const string Flea_Pins_Peaklands = "Flea_Pins_Peaklands";
    public const string Flea_Pins_Mucklands = "Flea_Pins_Mucklands";
    ...
    public const string Crow_Feathers = "Crow_Feathers";
